...
export const Tag = ({tag, tagIndex}) => {
    ...
    return (
        <>
            <div className="relative p-2 mt-2 px-5 bg-white rounded-full inline-block hover:bg-opacity-50 pr-8">
                <p className="outline-none" onClick={addEditable} onKeyDown={handleEditTag}>{tag}</p>
